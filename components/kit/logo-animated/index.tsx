...
export const AnimatedLogo: React.FC<IconProps> = ({ width = 200, height = 200 }) => {
  ...
  return (
    <View testID="animated-logo-container" style={styles.logoContainer}>
      <Svg testID="animated-logo" width={width} height={height} viewBox="0 0 64 64" fill="none">
        <AnimatedPath
          testID="animated-logo-left-bar"
        ...
        />
        <AnimatedPath
          testID="animated-logo-right-bar"
